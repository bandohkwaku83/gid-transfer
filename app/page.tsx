...
const aboutUsCopy = {
  title: "About Us",
  paragraphs: [
    "Gidtransfer was built by photographers who were tired of juggling galleries, contracts, invoices, and delivery across a dozen disconnected tools. We wanted one place that felt as polished as the work we deliver.",
    "Today, studios around the world use Gidtransfer to share branded galleries on their own domain, run proofing in minutes, and get paid — without a generic upload link or a platform badge on their brand.",
  ],
  cta: "Learn More",
  ctaHref: "/features",
} as const;
...
const heroCopy = {
  tagline:
    "Beautiful client galleries and studio tools to share, deliver, proof, and sell — all on your domain, without the generic upload link.",
  headline: ["Your work deserves", "a studio of its own."],
  primaryCta: "Start free — no card required",
  secondaryCta: "See the platform",
  trustLine: "14-day Pro trial · 0% commission on prints · Cancel anytime",
} as const;
    ...
    <div className="relative min-h-screen overflow-x-clip bg-paper text-slate-800">
      ...
      <main className="relative z-10">
          ...
          >
            ...
            >
              <div className="max-w-2xl">
                <h1
                  className="animate-landing-fade-up font-display text-[clamp(1.85rem,4.2vw,3.25rem)] font-medium leading-[1.08] tracking-[-0.02em] text-white"
        ...
        <section
          id="benefits"
          className={cn(
            "relative z-10 bg-[#FFFCF2] pb-16 pt-20 sm:pb-20 sm:pt-24",
            landingNavOffset,
          )}
        >
          <div className="marketing-container w-full">
            <div className="grid w-full grid-cols-1 gap-6 lg:grid-cols-3 lg:items-center lg:gap-0">
              {/* Left — joined image + video stack */}
              <div className="flex w-full">
                <div className="flex w-full flex-col overflow-hidden rounded-2xl lg:min-h-[32rem]">
                  {aboutSectionImages.map(({ src, alt, withPlay }) => (
                    <div
                      key={alt}
                      className="relative h-44 overflow-hidden sm:h-48 lg:min-h-0 lg:flex-1"
                    >
                      <Image
                        src={src}
                        alt={alt}
                      ...
                      {withPlay ? (
                        <div className="absolute inset-0 flex items-center justify-center bg-[#55001F]/30">
                          <span className="flex h-12 w-12 items-center justify-center rounded-full bg-white/95 text-[#55001F] shadow-lg sm:h-14 sm:w-14">
              ...
              <div className="relative z-10 w-full lg:-ml-8 lg:w-[calc(100%+4rem)] xl:-ml-10 xl:w-[calc(100%+5rem)]">
                <div className="flex w-full min-h-[560px] flex-col justify-center gap-8 rounded-2xl bg-[#55001F] p-8 shadow-[0_24px_60px_-20px_rgba(85,0,31,0.35)] sm:min-h-[600px] sm:p-10 lg:min-h-[44rem]">
                  <div>
                    ...
                    {aboutUsCopy.paragraphs.map((paragraph) => (
                      <p
                        ...
                        className="mt-5 text-sm leading-relaxed text-white/80 sm:text-[0.95rem]"
                      >
                        {paragraph}
                      </p>
                    ))}
                  ...
                  <a
                    ...
                    className="inline-flex w-fit rounded-xl bg-[#D5AE65] px-5 py-2.5 text-sm font-medium text-[#55001F] transition hover:bg-[#e0be75]"
                  >
                    {aboutUsCopy.cta}
                  </a>
                </div>
              ...
              <div className="flex w-full lg:pl-4 xl:pl-5">
                <div className="flex w-full flex-col justify-center rounded-2xl border border-slate-200/80 bg-white p-8 shadow-[0_12px_40px_-12px_rgba(85,0,31,0.12)] sm:p-10 lg:min-h-[32rem]">
                  <h2 className="font-display text-2xl font-semibold tracking-tight text-[#55001F] sm:text-[1.65rem]">
                    {whyChooseGido.title}
                  </h2>
                  <ul className="mt-8 space-y-7">
                    {whyChooseGido.reasons.map(({ title, description, icon: Icon }) => (
                      <li key={title} className="flex items-start gap-4">
                        <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg bg-[#D5AE65] text-white">
        ...
        <section
          ...
          className={cn(
            "relative overflow-hidden border-y border-slate-200 bg-[#0f172a] py-20 text-slate-100 sm:py-24",
            landingNavOffset,
          )}
        >
          ...
          <div className="relative marketing-container">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mx-auto mt-4 max-w-lg text-base text-slate-300">
                Join a growing community of photographers who swapped scattered tools for
                one studio that looks and feels unmistakably theirs.
              </p>
            </div>
